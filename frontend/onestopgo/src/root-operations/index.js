    ...
    return (
        <div className="row">
            ...
            <div className="col-9">
                ...
                <div className="form-floating mt-2">
                    <input type="time" className="form-control text-bg-light" id="openingTime" name="openingTime"
                           value=""/>
                    <label htmlFor="openingTime">Opening Time</label>
                </div>
                <div className="form-floating mt-2">
                    <input type="time" className="form-control text-bg-light" id="closingTime" name="closingTime"
                           value=""/>
                    <label htmlFor="closingTime">Closing Time</label>
                </div>
                <div>
                    <input type="file" className="form-control text-bg-light" id="storeImage" name="storeImage"/>
